    ...
    <div class="profileModal" id="profileModal">
        ...
        <div class="profileInfo">
            <?php if (isset($_SESSION['id'])): ?>
                ...
                <a href="#" class="font" id="logoutButton">
                    Sair da sessão
                </a>
            <?php endif ?>
            <?php if (!isset($_SESSION['id'])): ?>
                <p class="font">Bem vindo!</p>
                <p class="font">Faça <a class="font" href="./logins/FormLogar.php">Login</a> ou <a class="font" href="./logins/FormCadastrar.php">Cadastre-se</a>
                </p>
            <?php endif ?>
        </div>
